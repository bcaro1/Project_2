...
// ---------TELEPORTER CODE-------
var wobbleSpeedTele = 35;
var wobbleDistTele = 0.25;
Teleporter.prototype.act = function(step){
  this.wobble += step * wobbleSpeedTele;
  var wobblePos = Math.sin(this.wobble) * wobbleDistTele;
...
var wobbleSpeedGem = 8, wobbleDist = 0.07;

Gem.prototype.act = function(step) {
  this.wobble += step * wobbleSpeedGem;
...
Player.prototype.act = function(step, level, keys) {
  ...
  else if (level.status == "lostSlime") {
    this.pos.y -= step;
    this.size.y += step;
    this.size.x += step;
  }
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "slime" && this.status == null) {
    this.status = "lostSlime";
    this.finishDelay = 1;
  }
  else if (type == "gem") {
  ...
  if (type == 'teleporter'){
        this.player.pos = new Vector (67, 3);
  }
};
